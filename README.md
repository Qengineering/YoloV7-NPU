# YoloV7 NPU
![output image]( https://qengineering.eu/github/YoloV7_Parking_NPU.webp )
## YoloV7 for RK3566/68/88 NPU (Rock 5, Orange Pi 5, Radxa Zero 3). <br/>
...
$ mkdir *MyDir* <br/>
$ cd *MyDir* <br/>
$ git clone https://github.com/Qengineering/YoloV7-NPU.git <br/>
```
...
![output image]( https://qengineering.eu/github/YoloV7_Bus_NPU.webp )
